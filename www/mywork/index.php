...
<section class="slider">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<span class="h6 d-inline-block mb-2 subhead text-uppercase">JK-테크(JK-TECH)</span>
				<h3 class="text-uppercase text-white mb-1">새로운 시작 <span class="text-color">엘리베이터는 </span><br> JK-테크</h3>
