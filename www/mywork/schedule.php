...
<div class="card justify-content-center">	  
	<div class="card-header text-center"> 	
		<div class="row p-2 mt-3 mb-1 justify-content-center">	
			<span class="text-center fs-5" >작업스케줄표 <?=$workmsg?> </span>
		</div>
...
let getCal = getCookie("calendar");
  ...
  function calendar($el, options) {
    ...
    $el.on('click', '.js-cal-prev', function () {
      ...
      for (; y < l; y++) {
        s += '<button type="button" class="btn btn-primary btn-lg js-cal-option" data-date="' + (new Date(y, 1, 1)).toISOString() + '" data-mode="year">'+y + '</button>';
      }
