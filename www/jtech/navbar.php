...
<nav class="navbar navbar-expand-lg navigation fixed-top" id="navbar">
	<div class="container-fluid">
		<a class="navbar-brand" href="<?php echo getBaseUrl(); ?>/jtech/index.php">
		...
		<div class="collapse text-center navbar-collapse" id="navbarsid">
			<ul class="navbar-nav mx-auto">
				<li class="nav-item active">
					<a class="nav-link fs-2" href="<?php echo getBaseUrl(); ?>/jtech/index.php">Home <span class="sr-only">(current)</span></a>
				</li>				
				<li class="nav-item">				
						<?php if(intval($_SESSION["level"]) <= 2 ) {  ?>
							<a class="nav-link fs-2" href="<?php echo getBaseUrl(); ?>/jtech/write_form.php?mode=new" aria-haspopup="true"					aria-expanded="false">수주/발주 등록 </a>												
							<?php } ?>
				</li>				
								
				<li class="nav-item ">
					<a class="nav-link fs-2" href="<?php echo getBaseUrl(); ?>/jtech/list.php" aria-haspopup="true"
						aria-expanded="false"> 수주/발주 관리 </a>					
				</li>								
						
				<li class="nav-item">				
					<a class="nav-link fs-2 dropdown-toggle" href="<?php echo getBaseUrl(); ?>/jtech/schedule.php" aria-haspopup="true"
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu">
						...
						<?php if(intval($_SESSION["level"]) <= 2 ) {  ?>
						<li><a class="dropdown-item fs-2" href="<?php echo getBaseUrl(); ?>/jtech/memberlist.php">회원관리</a></li>											
							<?php } ?>						
					</ul>
				</li>
			</ul>
