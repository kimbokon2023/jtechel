...
<!-- Section Menu Start   메인과 다르게 크기 주의요함-->
<!-- Header Start -->
		...
		<div class="collapse text-center navbar-collapse" id="navbarsid">
			<ul class="navbar-nav mx-auto">
				<li class="nav-item active">				  
					<a class="nav-link fs-4" href="http://j-techel.co.kr/jtech/index.php">Home </a>					
				</li>				
				<li class="nav-item">
						<?php if(intval($_SESSION["level"]) <= 2 ) {  ?>
							<a class="nav-link fs-4" href="http://j-techel.co.kr/jtech/write_form.php?mode=new"> 수주/발주 등록 </a>					
						<?php } ?>								
					
				</li>				
								
				<li class="nav-item">
					<a class="nav-link fs-4" href="http://j-techel.co.kr/jtech/list.php"> 수주/발주 관리 </a>					
				</li>								
						
				<li class="nav-item">
					<a class="nav-link fs-4" href="http://j-techel.co.kr/jtech/schedule.php"> 종합일정관리 </a>
				</li>				
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu">
						...
						<?php if(intval($_SESSION["level"]) <= 2 ) {  ?>
						<li><a class="dropdown-item fs-4" href="http://j-techel.co.kr/jtech/memberlist.php">회원관리</a></li>						
							<?php } ?>
					</ul>
				</li>
			</ul>
